...
HELM_OVERWRITES="\
  ...
  --set EXTERNAL_SECRET_ELASTICSEARCH_PATH=${EXTERNAL_SECRET_ELASTICSEARCH_PATH} \
...
ELASTICSEARCH_CONFIGS=$(getModuleOverwrites "${ELASTICSEARCH_CONFIG_NAMES}" "ELASTICSEARCH_BROKER_PROTOCOL ELASTICSEARCH_BROKERS ELASTICSEARCH_PORT ELASTICSEARCH_USERNAME ELASTICSEARCH_PASSWORD")
HELM_OVERWRITES="${HELM_OVERWRITES} ${ELASTICSEARCH_CONFIGS}"
...
then
  ...
  echo "DEBUG POSTGRESQL_CONFIG_NAMES=${POSTGRESQL_CONFIG_NAMES}"
  echo "DEBUG KAFKA_CONFIG_NAMES=${KAFKA_CONFIG_NAMES}"
fi
